...
class DefinesDlg extends ModalDlg {
  constructor(defines, editor) {
    ...
    this.addRow([
      ...
      '<div class="col-md-5">\
      <math-field id="definesValue" type="text" style="width:100%;padding-left: 2px; padding-right: 2px; font-size: 20px; border-style: solid; border-width: 1px">\
      </math-field>\
      </div>',
    ]);
  ...
  Load\
    ...
    this.doAdd = function (name, value) {
      ...
      self.selector("definesValue")[0].value = "";
    ...
    this.addHandler("definesAdd", "click", function () {
      ...
      var value = self.selector("definesValue")[0].getValue("ascii-math");
    ...
    this.addHandler("definesName", "input", function (e) {
      if (
        ...
        if (define) self.selector("definesValue")[0].value = define;
      }
      ...
      if (
        self.selector("definesName").val().length &&
        _.isString(self.selector("definesName").val()) &&
        self.selector("definesValue")[0].getValue("ascii-math").length &&
        _.isString(self.selector("definesValue")[0].getValue("ascii-math"))
      ) {
    ...
    this.defineDlgInit = function () {
      Utility.extendGetValue(self.selector("definesValue")[0]);
      self.selector("definesAdd").attr("disabled", true);
      // self.selector("definesRemove").attr("disabled", true);
      // self.selector("definesRemoveAll").attr("disabled", true);
      if (!defines.definesSize()) {
